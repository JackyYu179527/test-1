...
VALUES ('V'|| LPAD(TO_CHAR(VENDER_SEQ.NEXTVAL),3,'0'), '1314一生一世專業禮車租借', '台北市信義區市府路45號', '02-664-9917', '黃穎筑', 'donna22@bosco.biz', 1, 1,'qwe', 'qwe', 0, CURRENT_TIMESTAMP, 30, 130);
INSERT INTO VENDER(VENDER_ID, VEN_NAME, VEN_ADDR, VEN_PHONE, VEN_CONTACT, VEN_MAIL, IS_VAILD, IS_ENABLE, VEN_ACCOUNT, VEN_PWD, VEN_SPONSOR, VEN_REGIS_TIME, VEN_REVIEW_COUNT, VEN_STARS_TOTAL)  
VALUES ('V'|| LPAD(TO_CHAR(VENDER_SEQ.NEXTVAL),3,'0'), '幸福久久結婚禮車','桃園市大園區三民路二段95號', '0973-318-520', '李經理', 'happiness99@happy.com.tw', 1, 1,'asd', 'asd', 0, CURRENT_TIMESTAMP, 20, 66 );
INSERT INTO VENDER(VENDER_ID, VEN_NAME, VEN_ADDR, VEN_PHONE, VEN_CONTACT, VEN_MAIL, IS_VAILD, IS_ENABLE, VEN_ACCOUNT, VEN_PWD, VEN_SPONSOR, VEN_REGIS_TIME, VEN_REVIEW_COUNT, VEN_STARS_TOTAL)  
VALUES ('V'|| LPAD(TO_CHAR(VENDER_SEQ.NEXTVAL),3,'0'),'Mr.Warmth工作室','高雄市前金區七賢二路123號', '0930-653-273', '張經理', 'warmth@gmail.com', 1, 1, 'warmth', 'warmth', 0, CURRENT_TIMESTAMP, 4, 19 );
INSERT INTO VENDER(VENDER_ID, VEN_NAME, VEN_ADDR, VEN_PHONE, VEN_CONTACT, VEN_MAIL, IS_VAILD, IS_ENABLE, VEN_ACCOUNT, VEN_PWD, VEN_SPONSOR, VEN_REGIS_TIME, VEN_REVIEW_COUNT, VEN_STARS_TOTAL)  
...
INSERT INTO VENDER(VENDER_ID, VEN_NAME, VEN_ADDR, VEN_PHONE, VEN_CONTACT, VEN_MAIL, IS_VAILD, IS_ENABLE, VEN_ACCOUNT, VEN_PWD, VEN_SPONSOR, VEN_REGIS_TIME, VEN_REVIEW_COUNT, VEN_STARS_TOTAL)  
VALUES ('V'|| LPAD(TO_CHAR(VENDER_SEQ.NEXTVAL),3,'0'), '攝日工作室','南投縣草屯鎮中正路905號', '0908280732', '劉先生', 'youngsxz8929@gmail.com', 1, 0, '123456789', '1234', 0, to_date('2020-06-03 09:05:08','yyyy-mm-dd hh24:mi:ss'), 0, 0);
...
INSERT INTO ADM(ADM_ID, ADM_ACCOUNT, ADM_PWD, ADM_NAME,ADM_0,ADM_1,ADM_2,ADM_3)
	VALUES ('ADM'|| LPAD(SEQ_ADM_ID.NEXTVAL, 3,'0'),'a0908280731@gmail.com','123','劉先生',1,1,1,1);
INSERT INTO ADM(ADM_ID, ADM_ACCOUNT, ADM_PWD, ADM_NAME,ADM_0,ADM_1,ADM_2,ADM_3)
	VALUES ('ADM'|| LPAD(SEQ_ADM_ID.NEXTVAL, 3,'0'),'123','123','劉先生',1,1,1,1);	       
